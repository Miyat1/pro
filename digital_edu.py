...
df.drop(['has_photo', 'id', 'has_mobile', 'graduation','career_start','career_end','city','relation','last_seen','life_main','people_main'], axis = 1, inplace = True)
...
print('Да:', round(accuracy_score(y_test, y_pred), 2) * 100)
